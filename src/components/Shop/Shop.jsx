    ...
    <div className="mt-[200px] flex gap-6 container">
      ...
      <div className="sidebar w-1/5 bg-orange p-5 overflow-hidden">
        <div className="fixed top-[33%] bottom-0 m-auto space-y-5">
          ...
          <p>Selected Items: 1</p>
          <p>Total Price: $444</p>
          <p>Total Shipping Charge: $3</p>
          <p>Tax $114</p>
          <p>
            <b>Grand Total: $243</b>
          </p>
          <button className="flex gap-2 btn justify-center items-center bg-[#FF3030] mx-auto py-3 px-4 rounded-sm text-white w-full">
